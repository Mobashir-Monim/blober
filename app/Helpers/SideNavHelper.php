...
class SideNavHelper extends Helper
{
    ...
    public function __construct(User $user)
    {
        ...
        array_push($this->items, ['route' => route('users.edit'), 'name' => 'Update Profile', 'width' => 'w-75']);
    ...
    public function super_admin()
    {
        ...
        array_push($this->items, ['route' => route('users.create'), 'name' => 'Add User', 'width' => 'w-75']);
        array_push($this->items, ['route' => route('datapool.index'), 'name' => 'Datapools', 'width' => 'w-100']);
        array_push($this->items, ['route' => route('datapool.create'), 'name' => 'Add Datapools', 'width' => 'w-75']);
        ...
        array_push($this->items, ['route' => route('quiz.create'), 'name' => 'Add Quiz', 'width' => 'w-75']);
    }
