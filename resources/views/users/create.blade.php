                    ...
                    <form action="{{ route('students.add') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 text-muted text-right" style="font-size: 0.8em">
                                <a href="http://view.officeapps.live.com/op/view.aspx?src={{ '/files/Blober Student Data test.xlsx' }}" target="_blank">View upload file format</a>
                            </div>
                        </div>
                    </form>
                </div>
                ...
                <div class="card-body my-0">
                    ...
                    <form action="{{ route('sections.create') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 text-muted text-right" style="font-size: 0.8em">
                                <a href="http://view.officeapps.live.com/op/view.aspx?src={{ request() . '/files/Blober Instructor Data Format.xlsx' }}" target="_blank">View upload file format</a>
                            </div>
                        </div>
                    </form>
                </div>
